...
class Dentist_Clients extends Widget_Base {

	public function get_name() {
		return 'dentist-clients';
	}

	public function get_title() {
		return __( 'Clients', 'dentist' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'clients_content',
			[
				'label' => __( 'Clients', 'dentist' ),
			]
		);
		$this->add_control(
            'clients', [
                'label' => __( 'Client', 'dentist' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'url',
                        'label' => __( 'Client Url', 'dentist' ),
                        'type'  => Controls_Manager::TEXT,
                        'default' => '#'
                    ],
                    [
                        'name'  => 'img',
                        'label' => __( 'Client Logo', 'dentist' ),
