...
class Dentist_Enqueue {

	public $scripts = array();

	public function dentist_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'dentist_frontend_enqueue_scripts', ) );
	}

	public function dentist_frontend_enqueue_scripts( ) {
