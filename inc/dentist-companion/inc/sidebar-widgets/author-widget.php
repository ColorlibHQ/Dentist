...
class dentist_author_widget extends WP_Widget {
...
'dentist_author_widget',


// Widget name will appear in UI
esc_html__( '[ Dentist ] Author Widget', 'dentist' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'dentist' ), )
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'dentist' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'designation' ) ); ?>"><?php esc_html_e( 'Designation:' ,'dentist'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'dentist'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'dentist'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'dentist'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'dentist'); ?></label>
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'dentist'); ?></label>
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'dentist' ); ?>:</label>
	<div class="dentist-media-container">
		<div class="dentist-media-inner">
			...
			<span class="dentist-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'dentist' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="dentist-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'dentist' ); ?>" class="button dentist-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'dentist' ) : __( 'Select Image', 'dentist' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button dentist-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.dentist-media-container {
	width: 98%;
}
...
.dentist-media-remove {
	float: left;
	width: 48%;
}

.dentist-media-upload {
	float: right;
	width: 48%;
}
</style>
...
jQuery(function($){
    ...
    wpshed_image_upload( '.dentist-media-upload' );
    ...
    wpshed_image_remove( '.dentist-media-remove' );
...
} // Class dentist_author_widget ends here


// Register and load the widget
function dentist_author_load_widget() {
	register_widget( 'dentist_author_widget' );
}
add_action( 'widgets_init', 'dentist_author_load_widget' );