 ...
 * @since 1.0
 */
class Dentist_Features extends Widget_Base {

	public function get_name() {
		return 'dentist-features';
	}

	public function get_title() {
		return __( 'Features', 'dentist' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Section Heading', 'dentist' ),
            ]
        );
        $this->add_control(
            'sect_title', [
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'dentist' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'dentist' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Font Icon', 'dentist' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_fonticon', [
                'label'     => __( 'Font Icon Color', 'dentist' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#67bc00',
                'selectors' => [
