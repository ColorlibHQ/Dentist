...
// image default alt
if( ! function_exists( 'dentist_img_default_alt' ) ) {
	function dentist_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'dentist_img_tag' ) ) {
	function dentist_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = dentist_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'dentist_anchor_tag' ) ) {
	function dentist_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'dentist' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'dentist_heading_tag' ) ) {
	function dentist_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'dentist' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'dentist_paragraph_tag' ) ) {
	function dentist_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'dentist_other_tag' ) ) {
	function dentist_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'dentist_button_element ' ) ) {
	function dentist_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'dentist' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
